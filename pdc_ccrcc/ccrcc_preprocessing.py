...
def main():
    ...
    # Import the data
    orig_df = pd.read_csv('data/ccRCC_TMT_intact glycopeptide_abundance_MD-MAD_50percentQuant_imputed.tsv', sep="\t")
    ...
    final_df[final_df['progression or recurrence_y'] != final_df['progression or recurrence']][['progression or recurrence','progression or recurrence_y']].dropna(how='any')
    ...
    final_df.to_csv('human_proteoform_ml_ready_pdc_ccrcc.csv', sep=',', index=False, quoting=csv.QUOTE_ALL)
